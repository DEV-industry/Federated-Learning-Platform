...
export default function configPage() {
  return (
    <div className="flex flex-col">
      <Header onReset={() => {}} downloadUrl="#" title="Config" />
      ...
      <div className="argon-card p-10 flex flex-col items-center justify-center text-center mt-6 min-h-[50vh]">
        ...
        <p className="text-argon-muted max-w-md">The Config module is actively being developed. New capabilities will be available here soon.</p>
